...
import { Alert, AlertType, ToastrService } from '../toastr.service';
...
export class ToastrComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.routeSubscription = this.router.events.subscribe(event => { if (event instanceof NavigationStart) { this.alertService.clear(this.id); } });
  }
